    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold text-dark mb-0">Create New Postman</h2>
            </div>

            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('pm.postmen.store') }}">
                        @csrf
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> This will create a new Postman account with internal user type and delivery operations access.
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('pm.postmen.index') }}" class="btn btn-secondary">Cancel</a>
                            <button type="submit" class="btn btn-success">
                                <i class="bi bi-person-plus me-2"></i>Create Postman
                            </button>
                        </div>
                    </form>
                </div>
