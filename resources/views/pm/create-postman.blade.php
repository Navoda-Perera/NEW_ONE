...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('pm.postmen.index') }}">Postmen</a></li>
        <li class="breadcrumb-item active">Create Postman</li>
    </ol>
</nav>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-person-plus me-2"></i>Create New Postman
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('pm.postmen.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Postman will be assigned to your post office location.</small>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('pm.postmen.index') }}" class="btn btn-secondary">
                            <i class="bi bi-arrow-left me-1"></i>Back to Postmen
                        </a>
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-person-plus me-1"></i>Create Postman
                        </button>
                    </div>
                </form>
            </div>
